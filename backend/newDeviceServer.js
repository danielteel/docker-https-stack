        ...
        if (this.netStatus===NETSTATUS.OPENED){                        
            ...
            if (data){
                if (data[0]===0xFF && data[1]===0xD8){
                    ...
                    const oldWeather=this.weather;//Testing
                    this.weather={};
                    ...
                    //Testing
                    if (oldWeather && this.name==='Greenhouse'){
                        if (!oldWeather.ticks) oldWeather.ticks=1;
                        if (oldWeather.ticks>15){
                            console.log(this.name, new Date().toLocaleTimeString(), this.weather.temperature);
                            this.weather.ticks=0;
                        }else{
                            this.weather.ticks=oldWeather.ticks+1;
                        }
                    }
                    //End Testing
                }
